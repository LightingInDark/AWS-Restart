...
#In this case, the issue is likely with the cipherKey variable, which is returned by 
#the getCipherKey function as a string. In the encryptMessage function, the cipherKey 
#variable is used in an arithmetic operation with the position variable, which causes 
